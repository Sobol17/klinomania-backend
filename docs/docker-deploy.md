...
Этот документ описывает деплой текущего Klinomania Backend (Laravel 13, PHP 8.3) на один VPS. На хосте уже работает внешний Nginx, который завершает HTTPS и проксирует запросы на `127.0.0.1:8080`.
